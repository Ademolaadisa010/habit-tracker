    ...
    <main className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="p-6 rounded-2xl" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="signup-email" className="text-sm font-medium" style={{ color: 'var(--color-muted)' }}>
                Email
              </label>
              <input
                id="signup-email"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="signup-password" className="text-sm font-medium" style={{ color: 'var(--color-muted)' }}>
                Password
              </label>
              <input
                id="signup-password"
        ...
        <p className="text-center text-sm mt-6" style={{ color: 'var(--color-muted)' }}>
          ...
          <Link href="/login" className="font-semibold" style={{ color: 'var(--color-accent-light)' }}>
            Sign in
          </Link>
        </p>
      </div>
